  ...
  return (
    <section id='hero'>
      <div className='hero--section side-padding d-flex flex-column justify-content-between'>
        ...
        <div
          className='hero--section-bottom row p-3'
          style={{ margin: 'auto' }}>
          <div className='hero--section-card col-lg-6'>
            <Image
              data-aos='fade-up'
              className='hero--card img-fluid'
              src={card}
              alt='hero-card'
            />
          </div>
          <div
            ...
            <h4>
              ...
              motorised card cutters and T-shirt printing machines.
            </h4>
            <h4>
              Our aim is to deliver quality products with maximum customer
              satisfaction.
            </h4>
            <div className='hero--bottom--buttons align-items-center'>
              ...
              <div className='about-button'>
                <a href='#about'>
                  <button
                    className='hero--button hero--about-button'
                    rel='noreferrer'>
                    About Us
                  </button>
                </a>
